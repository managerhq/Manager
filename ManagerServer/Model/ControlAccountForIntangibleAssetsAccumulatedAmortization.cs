...
{
    [ProtoContract]
    [Guid("47995ee3-b2c9-4799-ace3-768f7514c644")]
    public sealed class ControlAccountForIntangibleAssetsAccumulatedAmortization : ControlAccount, IBalanceSheetAccount, IJournalEntryAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual accumulated amortization account names.")]
