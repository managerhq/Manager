...
{
    [ProtoContract]
    [Guid("fb2c120e-6b30-47cb-a61e-14f0189bec06")]
    public sealed class ControlAccountForInvestments : ControlAccount, IBalanceSheetAccount, IReceiptOrPaymentAccount, IJournalEntryAccount, IPurchaseInvoiceAccount, ISalesInvoiceAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual investment names.")]
