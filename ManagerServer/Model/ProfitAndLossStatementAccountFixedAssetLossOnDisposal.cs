...
{
    [ProtoContract]
    [Guid("428ea9ba-4679-4568-b05b-7fcf62504893")]
    [Singleton]
    public sealed class ProfitAndLossStatementAccountFixedAssetLossOnDisposal : NamedObject, IProfitAndLossAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Name of account. The default name is `FixedAssetsLossOnDisposal` but it can be renamed.")]
        [ProtoMember(1), NoWrap, Placeholder(nameof(Strings.FixedAssetsLossOnDisposal))] public string Name { get; set; }
        ...
        public override string GetName()
        {
            ...
            return Strings.FixedAssetsLossOnDisposal;
        }
