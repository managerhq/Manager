...
{
    [ProtoContract]
    [Guid("de8d014f-e862-4ab5-88cc-335d464315a6")]
    [Singleton]
    public sealed class ProfitAndLossStatementCapitalGainsOnInvestments : NamedObject, IProfitAndLossAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Name of account. The default name is `InvestmentGainsLosses` but it can be renamed.")]
        [ProtoMember(1), NoWrap, Placeholder(nameof(Strings.InvestmentGainsLosses))] public string Name { get; set; }
        ...
        public override string GetName()
        {
            ...
            return Strings.InvestmentGainsLosses;
        }
