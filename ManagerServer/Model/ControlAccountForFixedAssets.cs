...
{
    [ProtoContract]
    [Guid("014742b2-fc31-4ded-90b5-2e0d437a1589")]
    public sealed class ControlAccountForFixedAssets : ControlAccount, IBalanceSheetAccount, IInventoryWriteOffAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, IPurchaseInvoiceAccount, ISalesInvoiceAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual fixed asset names.")]
        ...
        [ProtoMember(3), Autocomplete(typeof(ManagerServer.Model.BalanceSheetAbstractGroup)), Prepend(nameof(Strings.BalanceSheet)), TableColumn] public Guid? Group { get; set; }
