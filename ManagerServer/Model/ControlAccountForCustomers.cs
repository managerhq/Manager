...
{
    [ProtoContract]
    [Guid("7a57978e-583d-4997-86c7-c557de0e7fdd")]
    public sealed class ControlAccountForCustomers : ControlAccount, IBalanceSheetAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual customer names.")]
        ...
        [Guide("Select the cash flow statement group for operating activities. This determines where customer-related cash flows appear on the cash flow statement.")]
        [ProtoMember(18), EmptyLabel, Autocomplete(typeof(CashFlowStatementOperatingActivityGroup)), Prepend(nameof(Strings.CashFlowStatement), "-", nameof(Strings.OperatingActivities))] public Guid? CashFlowStatementGroup { get; set; }
