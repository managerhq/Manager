...
{
    [ProtoContract]
    [Guid("011cf167-ff32-49e7-b0f3-ac12a3fe43ed")]
    public sealed class AmortizationCalculationWorksheet : Object, IHasCustomTheme
    {
        [Guide("Enter the start date for the amortization calculation period.")]
        [ProtoMember(1)] public DateTime FromDate { get; set; }
        [Guide("Enter the end date for the amortization calculation period.")]
