...
{
    [ProtoContract]
    [Guid("aa80b662-3642-4c08-b328-2fccf132ceb1")]
    [Singleton]
    public sealed class ProfitAndLossStatementAccountInventoryPurchases : NamedObject, IProfitAndLossAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Name of account. The default name is `InventoryCost` but it can be renamed.")]
        [ProtoMember(1), NoWrap, Placeholder(nameof(Strings.InventoryCost))] public string Name { get; set; }
