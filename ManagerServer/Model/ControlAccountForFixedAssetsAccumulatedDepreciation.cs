...
{
    [ProtoContract]
    [Guid("c2e88cf8-4d05-4bec-8c42-fdef424faf1a")]
    public sealed class ControlAccountForFixedAssetsAccumulatedDepreciation : ControlAccount, IBalanceSheetAccount, IJournalEntryAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual accumulated depreciation account names.")]
