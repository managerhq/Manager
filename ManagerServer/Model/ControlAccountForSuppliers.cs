...
{
    [ProtoContract]
    [Guid("78e7aefb-9dff-4ae5-981e-4165b14fd963")]
    public sealed class ControlAccountForSuppliers : ControlAccount, IBalanceSheetAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual supplier names.")]
        ...
        [Guide("Select the cash flow statement group for operating activities. This determines where supplier-related cash flows appear on the cash flow statement.")]
