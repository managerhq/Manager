...
{
    [ProtoContract]
    [Guid("8ed99282-8ec3-4505-8846-0507bd0d0f70")]
    public sealed class ControlAccountForIntangibleAssets : ControlAccount, IBalanceSheetAccount, IReceiptOrPaymentAccount, IJournalEntryAccount, IPurchaseInvoiceAccount, ISalesInvoiceAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual intangible asset names.")]
