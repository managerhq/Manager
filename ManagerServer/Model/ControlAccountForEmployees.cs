...
{
    [ProtoContract]
    [Guid("fb804fba-df12-4628-ae54-df7a67d67f1b")]
    public sealed class ControlAccountForEmployees : ControlAccount, IBalanceSheetAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, IPurchaseInvoiceAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual employee names.")]
        ...
        [Guide("Select the cash flow statement group for operating activities. This determines where employee-related cash flows appear on the cash flow statement.")]
        [ProtoMember(19), EmptyLabel, Autocomplete(typeof(CashFlowStatementOperatingActivityGroup)), Prepend(nameof(Strings.CashFlowStatement), "-", nameof(Strings.OperatingActivities))] public Guid? CashFlowStatementGroup { get; set; }
