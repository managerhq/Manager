...
{
    [ProtoContract]
    [Guid("234d263d-cf0e-4e3e-85ca-ef899016e58a")]
    [Singleton]
    public sealed class ProfitAndLossStatementAccountBillableExpensesCost : NamedObject, IProfitAndLossAccount, IJournalEntryAccount, IReceiptOrPaymentAccount, ICode
    {
        [Guide("Name of account. The default name is `Billable_expenses_cost` but it can be renamed.")]
        [ProtoMember(1), NoWrap, Placeholder(nameof(Strings.Billable_expenses_cost))] public string Name { get; set; }
        ...
        public override string GetName()
        {
            ...
            return Strings.Billable_expenses_cost;
        }
