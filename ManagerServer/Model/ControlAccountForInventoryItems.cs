...
{
    [ProtoContract]
    [Guid("acc019f7-9bb9-4d8e-ba66-0956916b4247")]
    public sealed class ControlAccountForInventoryItems : ControlAccount, IBalanceSheetAccount, IInventoryOnHandAccount, ICode
    {
        [Guide("Enter the name of the control account. This name will appear on financial reports instead of individual inventory item names.")]
